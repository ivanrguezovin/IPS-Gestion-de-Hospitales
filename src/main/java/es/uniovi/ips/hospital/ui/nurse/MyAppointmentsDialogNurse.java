...
@Component
public class MyAppointmentsDialogNurse extends JDialog {

	private static final long serialVersionUID = -2910987113393599852L;
    ...
    private Nurse myself;

    public MyAppointmentsDialogNurse() {
        myself = new Nurse();
    ...
    public void run(Nurse nurse) {
        ...
        myAppointments.addAll(appointmentService.findAllByNurse(this.myself));
    ...
    private class ListReloader extends WindowAdapter {
        ...
        public void windowGainedFocus(WindowEvent arg0) {
            filterList.clear();
            filterList.addAll(appointmentService.findAllByNurse(myself));
        }
    }
}
