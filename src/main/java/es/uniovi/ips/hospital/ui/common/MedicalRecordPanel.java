...
@Component
public class MedicalRecordPanel extends JPanel implements Shiftable {
    ...
    public void showHistoryOf(Patient patient) {
		...
		tblMedicalRecord.getColumnModel().getColumn(0).setMinWidth(125);
		tblMedicalRecord.getColumnModel().getColumn(0).setMaxWidth(125);
